...
2. **General Form**: 
   $$(a_1 + a_2 + \dots + a_k)^n = \sum_{i_1 + i_2 + \dots + i_k = n} \frac{n!}{i_1! \, i_2! \, \dots \, i_k!} \cdot a_1^{i_1} a_2^{i_2} \dots a_k^{i_k}$$Here,$ C(n; i_1, i_2, \dots, i_k) = \frac{n!}{i_1! \, i_2! \, \dots \, i_k!} $ is the multinomial coefficient.
...
- **Example 1**: Expand $(x + y + z)^2$Using the multinomial theorem:$$(x + y + z)^2 = x^2 + y^2 + z^2 + 2xy + 2xz + 2yz$$
