...
$$(a + b)^n = \sum_{k=0}^{n} C(n, k) \cdot a^{n-k} \cdot b^k$$where$C(n, k)$, or "n choose k," represents the number of ways to select k elements from a set of n elements.
...
**Proof of Symmetry:**
To demonstrate this equality, substitute $C(n, k)$into the formula:$$C(n, k) = \frac{n!}{k!(n - k)!}$$Similarly, substituting$C(n, n - k)$:
$$C(n, n - k) = \frac{n!}{(n - k)!k!}$$Since both expressions are identical (the numerator and denominator are the same), we conclude that:$$C(n, k) = C(n, n - k)$$

**Examples Illustrating Symmetry:**
1. **Example 1:** Consider $n = 4$:
   $$C(4, 1) = \frac{4!}{1!(4-1)!} = \frac{24}{6} = 4$$$$C(4, 3) = \frac{4!}{3!(4 - 3)!} = \frac{24}{6} = 4$$Hence,$C(4, 1) = C(4, 3)$.

2. **Example 2:** Let $n = 5$:
   $$C(5, 2) = \frac{5!}{2!(5 - 2)!} = \frac{120}{12} = 10$$$$C(5, 3) = \frac{5!}{3!(5 - 3)!} = \frac{120}{12} = 10$$Thus,$C(5, 2) = C(5, 3)$.
