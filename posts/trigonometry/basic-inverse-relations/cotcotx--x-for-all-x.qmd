...
$$\cot(y) = x$$Thus,$\cot(\cot^{-1}(x)) = x$. This holds true regardless of whether $x$is positive or negative because$\cot^{-1}(x)$always returns an angle in the interval$(0, \pi)$, and the cotangent function will map this angle back to $x$.
