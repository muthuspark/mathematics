...
**3. Applying the Co-function Identity:**
   - The **co-function identity** states that for any angle $A$:
     $$\sin(A) = \cos\left(90^\circ - A\right)$$- Let’s set$ A = 90^\circ - \theta $. Substituting into the co-function identity:
     $$\sin\left(90^\circ - \theta\right) = \cos\left(90^\circ - (90^\circ - \theta)\right)$$- Simplifying inside the cosine function:$$\sin\left(90^\circ - \theta\right) = \cos(\theta)$$
