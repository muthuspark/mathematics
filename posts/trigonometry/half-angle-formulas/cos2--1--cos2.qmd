...
$$\cos(2\alpha) = 2\cos^2\alpha - 1$$Here, we let$ \alpha = \frac{\theta}{2} $. Substituting this into the equation gives:
...
$$\cos\theta = 2\cos^2\left(\frac{\theta}{2}\right) - 1$$**Isolate$ \cos^2\left(\frac{\theta}{2}\right) $**

Add 1 to both sides of the equation:

$$\cos\theta + 1 = 2\cos^2\left(\frac{\theta}{2}\right)$$Divide both sides by 2:$$\cos^2\left(\frac{\theta}{2}\right) = \frac{1 + \cos\theta}{2}$$
